/*
  ...
  This migration fixes all remaining functions with mutable search_path
  to protect against SQL injection attacks.
  
  All functions are recreated with:
  - SECURITY DEFINER for privilege escalation
  - SET search_path = public, pg_temp for security
  
  ## Functions Fixed
  - create_default_calculator_categories
  - auto_assign_task_by_job_title
  - calculate_task_deadlines
  - set_integration_credential
  - get_integration_credential
  - delete_integration_credentials
  - start_level2_stage
  - create_default_crm_stages_for_org
  - get_organizations_list
*/

-- =====================================================
-- FIX CALCULATOR CATEGORIES FUNCTION
-- =====================================================

DROP FUNCTION IF EXISTS create_default_calculator_categories(uuid);
...
-- =====================================================
-- FIX INTEGRATION CREDENTIAL FUNCTIONS
-- =====================================================
...
-- =====================================================
-- FIX CRM STAGES FUNCTION
-- =====================================================

DROP FUNCTION IF EXISTS create_default_crm_stages_for_org();
...
-- =====================================================
-- FIX ORGANIZATIONS LIST FUNCTION
-- =====================================================
