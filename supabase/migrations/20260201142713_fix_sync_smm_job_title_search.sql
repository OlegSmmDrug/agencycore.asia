/*
  # Fix SMM Job Title Search in Sync Function

  Update sync functions to find SMM users with flexible job title matching
  (supports 'СММ', 'SMM', 'SMM / Контент-менеджер', etc.)
*/
...
BEGIN
  ...
  WHERE p.id = p_project_id
    AND (u.job_title ILIKE '%СММ%' OR u.job_title ILIKE '%SMM%')
