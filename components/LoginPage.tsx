      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div className="relative z-10 space-y-8 max-w-lg">
            <h2 className="text-4xl font-light leading-tight">
                Управляйте бизнесом на <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-teal-400">новом уровне</span>.
            </h2>
            <div className="grid grid-cols-2 gap-4">
                <div className="p-5 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 transition-colors">
                    <p className="text-2xl font-bold text-blue-400 mb-1">CRM</p>
                    <p className="text-sm text-slate-300">Полный контроль над воронкой продаж</p>
                </div>
                <div className="p-5 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 transition-colors">
                    <p className="text-2xl font-bold text-indigo-400 mb-1">AI</p>
                    <p className="text-sm text-slate-300">Умный ассистент Gemini 2.5</p>
                </div>
            </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md space-y-10">
            <div className="text-center lg:text-left">
                <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Добро пожаловать</h2>
                <p className="mt-2 text-slate-500">Авторизуйтесь для доступа к системе</p>
            </div>
