...
import { User, Mail, Lock, Camera, Save, Shield, UserIcon, CheckCircle, AlertCircle, Eye, EyeOff, CreditCard, Gift, Bell, Phone } from 'lucide-react';
                ...
                <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
                    <div className="max-w-3xl mx-auto">
                        ...
                        {activeTab === 'contact' && (
                            <div className="space-y-4 sm:space-y-6">
                                <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
                                    <h2 className="text-base sm:text-lg font-semibold text-slate-800 mb-4">Контактные данные</h2>
                                    <div className="space-y-4">
                                        <div>
                                            <label className="block text-sm font-medium text-slate-700 mb-2">
                                                Электронная почта
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-400 mt-1.5">Используется как контакт менеджера при шаринге проектов</p>
                                        </div>
                                    </div>
                                </div>
